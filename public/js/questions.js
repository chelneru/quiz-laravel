...
function applyFilters() {
  var quiz_filter = $('#quiz-dropdown').find('option:selected').val();
  var class_filter = $('#class-dropdown').find('option:selected').val();
...
module.exports = __webpack_require__(/*! C:\WORK\saga-project\resources\js\questions.js */"./resources/js/questions.js");
